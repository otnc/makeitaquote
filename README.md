...
| --- | --- | --- |
| `avatar` | `'guild'` | Per-server avatar, falling back to the account's |
| `avatar` | `'global'` | Account avatar, falling back to the server's |
| `name` | `'nickname'` | Server nickname, falling back to the global name |
| `name` | `'global'` | Global name, falling back to the server nickname |
...
<a href="https://discord.gg/yKW8wWKCnS"><img src="https://discordapp.com/api/guilds/1005287561582878800/widget.png?style=banner4" alt="Discord"/></a>
